...
\hypersetup{
  ...
  pdfauthor={George Athanasopoulos CRETE2025, Tinos, Greece},
  hidelinks,
...
\begin{frame}{FLAP (Forecast Linear Augmented Projection)}
\phantomsection\label{flap-forecast-linear-augmented-projection}
Intuition:
...
\hspace{1cm}
\includegraphics[width=0.38\linewidth,height=\textheight,keepaspectratio]{github.png}
