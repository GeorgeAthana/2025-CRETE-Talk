...
<!-- Weekly A\&E demand data: 7 November 2010 to 7 June 2015.\fontsize{10}{11}\sf -->
...
<!-- ## Example: Forecasting A\&E admissions -->

<!-- \structure{Objectives:} -->

<!-- - 1 year ahead (staff training); -->
<!-- - 3 months ahead (staff planning and procurement); -->
<!-- - 4 weeks ahead (staffing schedules); -->
<!-- - 1 week (calibrate existing plans). -->


<!-- \structure{Data:} -->

<!-- - `ARIMA()` base forecasts. -->
<!-- - Test set: last 52 weeks. Rolling origin evaluation. -->
...
<!-- \placefig{0.8}{2.2}{height=6.2cm, width=13.5cm}{AEexample.pdf}

<!-- \placefig{0.1}{1.1}{width=15.8cm, height=7.8cm}{tourism1}
...
<!--   kable(booktabs = TRUE, align = "lrrrr",format = "latex", -->
<!--     escape = FALSE, -->
<!--     linesep = "")   -->
...
<!-- \only<1>{\includegraphics[page=1, width=11cm]{figs/FLAP_geometry.pdf}} -->
<!-- \only<2>{\includegraphics[page=2, width=11cm]{figs/FLAP_geometry.pdf}} -->
<!-- \only<3>{\includegraphics[page=3, width=11cm]{figs/FLAP_geometry.pdf}} -->
<!-- \only<4>{\includegraphics[page=4, width=11cm]{figs/FLAP_geometry.pdf}} -->
<!-- \only<5>{\includegraphics[page=5, width=11cm]{figs/FLAP_geometry.pdf}} -->
...
<!--    - $\Var(\bm{z}_{t+h} - \textcolor{blue}{\hat{\bm{z}}_{t+h}}) -\Var(\bm{z}_{t+h} - \textcolor{red}{\tilde{\bm{z}}_{t+h}})$ -->
...
<!-- - Optimal Forecast Reconciliation for Quantiles, with Anastasios Panagiotelis, Nam Ho-Nguyen, Hossein Alipour (almost complete). -->
<!-- - Immutable and non-negative MinT forecasts, with Shanika Wickramasuriya and students (under development). -->
...
<!-- [\color{Blue}{https://github.com/GeorgeAthana/2024-INFORMS}](https://github.com/GeorgeAthana/2024-INFORMS) -->
